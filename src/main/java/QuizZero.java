...
public class QuizZero {
    ...
    // write code to pass the test
    public static  boolean Qaay(boolean a, boolean b) { return a&&b; }
    // write code to pass the test
    public static  boolean Qbee(boolean a, boolean b) { return a||b; }
    // write code to pass the test
    ...
    public static  int Qeee(double x, double y) { return ((x-y)<0.0001)?(0):(1); }
